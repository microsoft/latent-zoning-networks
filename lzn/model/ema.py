...
# Modified from
# https://github.com/gnobitab/RectifiedFlow/blob/main/ImageGeneration/models/ema.py
# Modified from
# https://raw.githubusercontent.com/fadel/pytorch_ema/master/torch_ema/ema.py
...
class ExponentialMovingAverage(object):
    ...
    def __init__(self, parameters, decay, use_num_updates=True):
        ...
        self.shadow_param_masks = [p.requires_grad for p in parameters]
    ...
    def update(self, parameters):
        ...
        with torch.no_grad():
            parameters = [
                p for p, m in zip(parameters, self.shadow_param_masks) if m
            ]
