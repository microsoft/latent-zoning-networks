...
def get_config():
    ...
    config.eval_batch_size = 2000
    config.result_folder = "./results/case_study_3"
    ...
    config.training.num_encoder_iterations = 200000
    config.training.num_label_anchor_iterations = 200000
    config.training.ode_num_steps = 20
    config.training.label_ode_num_steps = 100
    config.training.label_loss_cut_off_step = 0.2

    config.training.enable_mixed_precision_training = False

    config.training.recon_loss_coe = 1.0
    config.training.label_loss_coe = 1.0
    ...
    config.checkpoint.iteration_freq = 1000
    ...
    config.label_anchor_ema = ml_collections.ConfigDict()
    config.label_anchor_ema.enabled = True
    config.label_anchor_ema.params = ml_collections.ConfigDict()
    config.label_anchor_ema.params.decay = 0.999999
    config.label_anchor_ema.params.use_num_updates = True
    ...
    config.label_latent_flow = ml_collections.ConfigDict()
    config.label_latent_flow.name = "lzn.latent_flow.euler_latent_flow.EulerLatentFlow"
    config.label_latent_flow.params = ml_collections.ConfigDict()
    ...
    config.data.name = "lzn.data.cifar10.CIFAR10"
    config.data.params = ml_collections.ConfigDict()
    config.data.params.root = "/tmp/cifar10"
    config.data.params.conditional = config.get_ref("conditional")
    ...
    config.encoder.params.config.model.scale_by_sigma = False
    config.encoder.params.config.model.ema_rate = 0.999999
    ...
    config.encoder.params.config.model.ch_mult = (1, 2, 2, 2)
    config.encoder.params.config.model.num_res_blocks = 4
    ...
    config.encoder.params.config.model.fir = False
    ...
    config.encoder.params.config.model.progressive = "none"
    config.encoder.params.config.model.progressive_input = "none"
    ...
    config.encoder.params.config.model.embedding_type = "positional"
    ...
    config.encoder.params.config.model.sigma_max = 50
    config.encoder.params.config.model.num_scales = 1000
    config.encoder.params.config.model.beta_min = 0.1
    config.encoder.params.config.model.beta_max = 20.0
    config.encoder.params.config.model.dropout = 0.15
    ...
    config.label_anchor = ml_collections.ConfigDict()
    config.label_anchor.name = "lzn.label_anchor.label_anchor.LabelAnchor"
    config.label_anchor.params = ml_collections.ConfigDict()
    config.label_anchor.params.z_dim = config.get_ref("latent_dim")
    config.label_anchor.params.num_classes = 10
    ...
    config.optimizer.additional_params.encoder_lr = 0.00005
    config.optimizer.additional_params.decoder_lr = 0.002
    config.optimizer.additional_params.label_anchor_lr = 0.0001
    ...
    random_samples_more_metric_config.params.num_samples_per_class = 5000
    ...
    random_samples_metric_config.params.num_samples_per_class = 100
    random_samples_metric_config.params.batch_size = config.get_ref(
        "eval_batch_size"
    )
    random_samples_metric_config.iteration_freq = 5000
    ...
    reconstructions_with_computed_ini_noise_metric_config.params.num_samples = 2000
    ...
    reconstructions_with_computed_ini_noise_metric_config.iteration_freq = 5000
    ...
    clean_fid_metric_config.iteration_freq = 5000
    ...
    rf_fid_metric_config.iteration_freq = 5000
    rf_fid_metric_config.epoch_freq = -1
    rf_fid_metric_config.apply_on_ema = True
    rf_fid_metric_config.apply_on_samplers = True

    class_accuracy_metric_config = ml_collections.ConfigDict()
    class_accuracy_metric_config.name = (
        "lzn.metric.class_accuracy.ClassAccuracy"
    )
    class_accuracy_metric_config.params = ml_collections.ConfigDict()
    class_accuracy_metric_config.params.num_samples = -1
    class_accuracy_metric_config.params.batch_size = config.get_ref(
        "eval_batch_size"
    )
    class_accuracy_metric_config.iteration_freq = 5000
    class_accuracy_metric_config.epoch_freq = -1
    class_accuracy_metric_config.apply_on_ema = True
    class_accuracy_metric_config.apply_on_samplers = False

    tunable_std_class_accuracy_metric_config = ml_collections.ConfigDict()
    tunable_std_class_accuracy_metric_config.name = (
        "lzn.metric.tunable_std_class_accuracy.TunableStdClassAccuracy"
    )
    tunable_std_class_accuracy_metric_config.params = ml_collections.ConfigDict()
    tunable_std_class_accuracy_metric_config.params.num_samples = -1
    tunable_std_class_accuracy_metric_config.params.batch_size = config.get_ref(
        "eval_batch_size"
    )
    tunable_std_class_accuracy_metric_config.iteration_freq = 5000
    tunable_std_class_accuracy_metric_config.epoch_freq = -1
    tunable_std_class_accuracy_metric_config.apply_on_ema = True
    tunable_std_class_accuracy_metric_config.apply_on_samplers = False
    ...
    config.metrics = [
        ...
        class_accuracy_metric_config,
        tunable_std_class_accuracy_metric_config,
    ]
