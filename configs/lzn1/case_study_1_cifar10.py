...
def get_config():
    ...
    config.result_folder = "./results/case_study_1_cifar10"
    ...
    config.training.num_decoder_iterations = 50000
    config.training.num_encoder_iterations = 50000
    ...
    config.optimizer.additional_params.encoder_lr = 0.000025
    config.optimizer.additional_params.decoder_lr = 0.001
    ...
    random_samples_more_metric_config.params.num_samples_per_class = 50000
