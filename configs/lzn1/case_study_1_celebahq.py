...
def get_config():
    ...
    config.result_folder = "./results/case_study_1_celebahq"
    ...
    config.training.num_decoder_iterations = 350000
    config.training.num_encoder_iterations = 350000
    ...
    config.decoder_ema.params.decay = 0.9999
    ...
    config.data.name = "lzn.data.celeba_hq.CelebAHQ"
    config.data.params = ml_collections.ConfigDict()
    config.data.params.root = "/tmp/data/CelebA-HQ-1024"
    ...
    config.optimizer.additional_params.encoder_lr = 4e-6
