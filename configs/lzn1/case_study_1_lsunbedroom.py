...
def get_config():
    ...
    config.eval_batch_size = 25
    config.result_folder = "./results/case_study_1_lsunbedroom"
    ...
    config.training.num_decoder_iterations = 2050000
    config.training.num_encoder_iterations = 2050000
    ...
    config.decoder_ema.params.decay = 0.99999
    ...
    config.encoder_ema.params.decay = 0.99999
    ...
    config.data.name = "lzn.data.lsun.LSUN"
    config.data.params = ml_collections.ConfigDict()
    config.data.params.lsun_root = "/tmp/data/LSUN"
    config.data.params.category = "bedroom"
    ...
    config.encoder.params.config.model.sigma_max = 380
    ...
    random_samples_more_metric_config.params.num_samples_per_class = 29952
